...
void GH30X_HrAlgorithmResultReport(STGh30xAlgoResult *pstAlgoResult, GU32 lubFrameId)
{
    ...
    // EXAMPLE_DEBUG_LOG_L1("[HeartRate] value: %d", pstAlgoResult->snResult[0]);
   EXAMPLE_DEBUG_LOG_L1("[HR]hba=%d, valid_score=%d, hba_snr=%d, valid_level=%d, hba_acc_info=%d, hba_acc_scence=%d\r\n", \
