        ...
        lv_obj_t *parent_obj = obj;
        {
                                   ...
                                   LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                lv_obj_t *parent_obj = obj;
                {
                    ...
                    lv_obj_set_style_text_color(obj, lv_color_hex(0xff00ff00),
                                                LV_PART_MAIN |
                                                    LV_STATE_DEFAULT);
...
{
    if (gnss_manager_open() != RT_EOK)
    {
        LOG_E("location open gnss failed");
    }
    create_ui();
...
static void on_stop(void)
{
    ...
    if (gnss_manager_close() != RT_EOK)
    {
        LOG_W("location close gnss failed");
    }
}
